...
const ROUTES = [
  ...
  { pattern: /^\/finance\/fixed-expense/,    component: () => FixedExpensePage, tab: 'finance' },
  ...
  { pattern: /^\/notes/,                    component: () => StudioPage,    tab: 'home' },
  { pattern: /^\/wishlist/,                 component: () => WishlistPage, tab: null },
  { pattern: /^\/puff\/orders\/new/,   component: () => OrderForm,   tab: null },
  { pattern: /^\/puff\/orders\/edit/,  component: () => OrderForm,   tab: null },
  ...
  { pattern: /^\/puff\/menus\/select/,   component: () => ProductSelectPage, tab: null },
